...
"""
Persistent CD tomography script derived from the user's CD benchmark.

Main change relative to the plain CD version:
- uses persistent fantasy particles
- resets 1% of chains per update from the Z-basis pool

Philosophy:
- keep the exact positive term
- replace only the amplitude model expectation by a PCD-k estimate
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 80)
    print(f"Running PCD experiment with k = {PCD_K} and reset_frac = {RESET_FRAC}")
    print("=" * 80)
