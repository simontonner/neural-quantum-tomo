...
class RBMTomographyLoader:
    ...
    Important:
      This loader keeps the original pooled positive-batch semantics.
      When all measurement settings have the same shot count, a pooled
      positive minibatch is an unbiased stochastic estimator of the
      basis-averaged data objective up to an overall constant factor.
    """
...
if __name__ == "__main__":
    ...
    if ep_hist and ("Fidelity" in history) and ("KL" in history):
        ...
        ax1.set_title("RBM Tomography - pooled autodiff CD with delayed dual LR")
