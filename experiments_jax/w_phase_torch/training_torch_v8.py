    ...
    def fit(self, loader, epochs=70, k=10, lr=1e-1, log_every=5, optimizer=torch.optim.SGD, optimizer_args=None,
        ...
        for ep in range(1, epochs + 1):
            ...
            for pos_batches, neg_batch in loader.iter_epoch():
                ...
                # Scaled theory-matched minibatch objective:
                #   loss = (1/(R+1)) * sum_r mean_{B_r}[data term]_r - mean_{B~}[F_lambda]
                # This preserves the explicit basis structure of the theory while matching
                # the optimization scale of the stable pooled implementation.
                pos_term = L_pos / float(num_bases)
...
if __name__ == "__main__":
    ...
    if ep_hist and ("Fidelity" in history) and ("KL" in history):
        ...
        ax1.set_title("RBM Tomography - scaled theory-matched explicit basis minibatches")
