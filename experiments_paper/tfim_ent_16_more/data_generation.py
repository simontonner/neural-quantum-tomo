...
if __name__ == "__main__":
    ...
    #h_values = [0.50, 0.80, 0.90, 0.95, 1.00, 1.05, 1.10, 1.20, 1.50, 2.00] # dense (recommended for entanglement study)
    h_values = [0.50, 0.80, 0.95, 1.00, 1.05, 1.20, 1.50] # medium
    #h_values = [0.80, 1.00, 1.20] # sparse
