# RBM wavefunction — complex-first with guardrailed loader
# -----------------------------------------------------------------------------
...
# - Minimal surface: short docstrings, inline comments for the why.
# - Numerical stance:
#     * Use cdouble for psi/rotations/overlaps to avoid phase-roundoff amplification.
#     * Safe inverse: denom clamp when branch sums ~0 to avoid blowups.
#     * Normalize target once; renormalize per rotated basis for KL (drift control).
...
if __name__ == "__main__":
    ...
    # (optional) also make NumPy deterministic if you care about np ops downstream
    # np.random.seed(1234)
    ...
    # If you want a dedicated RNG stream for the loader, uncomment:
