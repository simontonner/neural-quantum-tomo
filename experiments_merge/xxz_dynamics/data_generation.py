...
from data_handling import MultiQubitMeasurement, save_state_npz, save_measurements_txt
...
def main() -> None:
    ...
    for delta in delta_values:
        ...
        meas_path = out_meas / f"xxz_{system_shape}_delta{delta:.2f}_{num_samples}.txt"
